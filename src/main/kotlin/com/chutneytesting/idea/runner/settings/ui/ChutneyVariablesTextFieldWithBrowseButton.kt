...
class ChutneyVariablesTextFieldWithBrowseButton : TextFieldWithBrowseButton(), UserActivityProviderComponent {
    ...
    private inner class MyChutneyVariablesDialog : DialogWrapper(this@ChutneyVariablesTextFieldWithBrowseButton, true) {
        private val myEnvVariablesTable: EnvVariablesTable
        ...
        init {
            myEnvVariablesTable = EnvVariablesTable()
            myEnvVariablesTable.setValues(convertToVariables(myData.envs, false))
    ...
    companion object {
        ...
        private fun convertToVariables(map: Map<String, String>, readOnly: Boolean): List<EnvironmentVariable> {
