...
abstract class ChutneyLineMarkerProvider : LineMarkerProvider {
    ...
    protected fun lineMarkerInfo(anchor: PsiElement, displayName: String): LineMarkerInfo<PsiElement> {
        return LineMarkerInfo(
            anchor,
            anchor.textRange,
            IconLoader.getIcon("/runConfigurations/testState/run_run.png"),
    ...
    private fun showPopup(e: MouseEvent, psiElement: PsiElement, displayName: String) {
        JBPopupFactory.getInstance()
            ...
            .setRenderer(object : ListCellRendererWrapper<Type>() {
                override fun customize(p0: JList<*>?, value: Type?, index: Int, selected: Boolean, hasFocus: Boolean) {
                    setIcon(value?.icon)
