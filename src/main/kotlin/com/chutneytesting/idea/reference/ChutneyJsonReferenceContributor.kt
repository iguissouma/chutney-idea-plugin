...
class ChutneyJsonReferenceContributor : PsiReferenceContributor() {
    ...
    val REF_PATTERN = createPropertyValuePattern("\$ref", false, false)
    ...
    fun localVariablesPattern(): PsiElementPattern.Capture<JsonLiteral> {
    ...
    private fun createPropertyValuePattern(
        ...
        return PlatformPatterns.psiElement(JsonValue::class.java).and(FilterPattern(object : ElementFilter {
    ...
    fun createLocalVariablesProvider(): PsiReferenceProvider {
                ...
                return generateSequence(variableRegex.find(element.text)) {
                    ...
                    .map {
                        ChutneyVariableReference(
                            ...
                            traversal,
                            element,
                            TextRange(it.range.start + 1, it.range.endInclusive)
                        )
                    }
                    .toList()
                    .toTypedArray()
